...
function CVArea({fullName, birthDate, mail, mobilNum, educationObjectList, practicalObjectList, setEducationObjectList, setPracticalObjectList, setFullName, setBirthDate, setMail, setMobil, queryID, queryIDPractical, updateEducationState, setEducationEditBtn, toggleEdit }) {
  return (
    <>
      ...
      <EducationOutputSection educationObjectList= {educationObjectList} queryID= {queryID} updateEducationState= {updateEducationState} setEducationEditBtn= {setEducationEditBtn} toggleEdit= {toggleEdit} />
